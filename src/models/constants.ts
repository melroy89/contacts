...
export const CIRCLES_MEMBER_GROUPING = [
	...
	// {
	// id: `picker-${ShareType.SHARE_TYPE_REMOTE}`,
	// label: t('contacts', 'federated users'),
	// share: ShareType.SHARE_TYPE_REMOTE,
	// type: MEMBER_TYPE_USER
	// },
	// {
	// id: `picker-${ShareType.SHARE_TYPE_REMOTE_GROUP}`,
	// label: t('contacts', 'federated groups'),
	// share: ShareType.SHARE_TYPE_REMOTE_GROUP,
	// type: MEMBER_TYPE_GROUP
	// },
	{
